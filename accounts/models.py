...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    phone = models.CharField(verbose_name=_("Phone Number"), validators=[phoneNumberRegex], unique=True, max_length=11)
    password = models.CharField(verbose_name=_("Password"), max_length=8)
