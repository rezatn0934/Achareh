...
DEFAULT_CACHE_DATABASE = os.environ.get('DEFAULT_CACHE_DATABASE', 1)
DEFAULT_CACHE_TTL = os.environ.get('DEFAULT_CACHE_TTL')

OTP_CACHE_DATABASE = os.environ.get('OTP_CACHE_DATABASE', 2)
OTP_CACHE_TTL = os.environ.get('OTP_CACHE_TTL', 5*60)
